...
#define START_MASTERNODE_PAYMENTS_TESTNET 1436281360
#define START_MASTERNODE_PAYMENTS 1436281360

static const int64_t DARKSEND_COLLATERAL = (30000*COIN);
static const int64_t DARKSEND_FEE = (0.0001*COIN);
static const int64_t DARKSEND_POOL_MAX = (3000000.99*COIN);
...
static const int64_t COIN_YEAR_REWARD = 5 * CENT; // 5% yearly
