...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QRect amountRect(mainRect.left() + 10, mainRect.top()+ypad, mainRect.width() - yspace, halfheight);
        QRect addressRect(mainRect.left() + 10, mainRect.top()+ypad+halfheight, mainRect.width() - yspace, halfheight);
...
void OverviewPage::updateDarksendProgress()
{
    ...
    int64_t nMaxToAnonymize = nAnonymizeCryptoSpotsAmount*COIN;
...
void OverviewPage::darkSendStatus()
{
    ...
    if(nBestHeight != darkSendPool.cachedNumBlocks)
    {
        ...
        strSettings.prepend(BitcoinUnits::formatWithUnit(
            ...
            nAnonymizeCryptoSpotsAmount * COIN)
        );
...
void OverviewPage::toggleDarksend(){
    ...
    if(!fEnableDarksend){
        ...
        if(nAnonymizeCryptoSpotsAmount == 0){
