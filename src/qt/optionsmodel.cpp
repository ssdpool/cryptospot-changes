...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCryptoSpotsAmount"))
        settings.setValue("nAnonymizeCryptoSpotsAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCryptoSpotsAmount = settings.value("nAnonymizeCryptoSpotsAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCryptoSpotsAmount"))
        SoftSetArg("-anonymizeCryptoSpotsamount", settings.value("nAnonymizeCryptoSpotsAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCryptoSpotsAmount:
            nAnonymizeCryptoSpotsAmount = value.toInt();
            settings.setValue("nAnonymizeCryptoSpotsAmount", nAnonymizeCryptoSpotsAmount);
            emit anonymizeCryptoSpotsAmountChanged(nAnonymizeCryptoSpotsAmount);
            break;
        default:
            break;
        }
