    ...
    nWeight(0)
{
	...
	QFontDatabase::addApplicationFont(":/fonts/Replay");
    setWindowTitle(tr("CryptoSpots") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send CryptoSpots"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a CryptoSpots address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive CryptoSpots"), this);
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&CryptoSpots Nodes"), this);
    masternodeManagerAction->setToolTip(tr("Show CryptoSpots Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    masternodeManagerAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(QIcon(":/icons/edit"), tr("CryptoSpots Messages"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About CryptoSpots"), this);
    aboutAction->setToolTip(tr("Show information about CryptoSpots"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for CryptoSpots"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("#toolbar {margin-top: 14px; height:100%;padding-top:100px; background: transparent; text-align: center; color: white;min-width:200px;max-width:200px;} QToolBar QToolButton:hover {background-color: transparent;} QToolBar QToolButton:selected {background-color: transparent;} QToolBar QToolButton:checked {background-color: transparent;} QToolBar QToolButton:pressed {background-color: transparent;} QToolBar QToolButton { font-family:'Replay'; font-size:22px; min-width:180px;max-width:180px; min-height:40px;max-height:40px; color: white; text-align: center; }");
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CryptoSpots client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CryptoSpots client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoSpots network", "", count));
}
...
{
    QString strTitle = tr("CryptoSpots") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CryptoSpots address or malformed URI parameters."));
    }
